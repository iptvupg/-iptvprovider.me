          ...
          {PLATFORMS.map((p, i) => (
            ...
            >
              <svg
                ...
                fill="currentColor"
                className="text-secondary transition-colors duration-500 group-hover:text-acid"
              >
                <path d={p.d} />
              </svg>
